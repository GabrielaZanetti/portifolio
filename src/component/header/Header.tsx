...
function Header() {
    ...
    document.body.style.overflow =
        showMobileMenu && isMobile ? 'hidden' : 'auto'
            ...
            <div className="Header">
                <div className="header-itens">
                    ...
                    <div className="nav-bar">
                        ...
                        <div className="nav">
                            <a href="/portifolio/#Sobre" className="nav-item">
                                Sobre
                            </a>
                            <a
                    ...
                    {isMobile && (
                        <div
                            id="menu-mobile"
                            className={`nav-mobile ${showMobileMenu ? 'show' : 'hide'}`}
                        >
                            <div className="itens-mobile">
                                <a
                                    onClick={() => setShowMobileMenu(false)}
                                    href="/portifolio/#Sobre"
                                    className="nav-item"
                                >
                                    Sobre
                                </a>
